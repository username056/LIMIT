...
class BatteryReportFileFetcherTests {

    private static final String FILE_URL = "https://cdn.example.com/evidence/9005.html";

    @Test
    void fetchReturnsFileBytesOnSuccess() {
        var builder = RestClient.builder();
        var server = MockRestServiceServer.bindTo(builder).build();
        var fetcher = new BatteryReportFileFetcher(builder);
        ...
        assertThat(new String(bytes)).isEqualTo("<html></html>");
        server.verify();
    }
                ...
                .isInstanceOfSatisfying(
                        ...
                        exception ->
                                assertThat(exception.getErrorCode())
                                        .isEqualTo(ErrorCode.BATTERY_REPORT_FILE_FETCH_FAILED));
        server.verify();
    }
}

...
class PaymentSecurityControllerTests {
    ...
    @MockitoBean ChatMediaRepository chatMediaRepository;
    @MockitoBean ChatMessageMediaRepository chatMessageMediaRepository;
    @MockitoBean ChatRoomContextReader chatRoomContextReader;

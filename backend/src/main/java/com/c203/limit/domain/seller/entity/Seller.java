...
@Entity @Table(name="seller") public class Seller {
 ...
 public static Seller approve(SellerApplication a,int productLimit,BigDecimal salesAmountLimit){var s=approve(a);s.updateLimits(productLimit,salesAmountLimit);return s;}

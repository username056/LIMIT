...
public interface ProductApi {
    ...
    @Operation(operationId = "product04", summary = "상품 목록 조회", description = "공개 판매 상품을 기기·가격·지역·검증 상태로 검색합니다. 정렬은 createdAt, price, viewCount를 지원하며 `필드,asc|desc` 형식입니다. 인기순은 `viewCount,desc`입니다.")

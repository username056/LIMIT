...
@Schema(name = "AdminActionLogDetailResponse", description = "관리자 감사 로그 상세")
public class AdminActionLogDetailResponse {
    ...
    @Schema(description = "변경 전 주요 값", example = "{}", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private final Map<String, Object> beforeData;

    @Schema(description = "변경 후 주요 값", example = "{}", requiredMode = Schema.RequiredMode.NOT_REQUIRED)

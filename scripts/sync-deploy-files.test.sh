...
grep -Fxq "scripts/apply-ec2-env-remote.sh" "$test_dir/monitoring.files"
grep -Fxq "scripts/configure-rtc-turn.sh" "$test_dir/monitoring.files"
grep -Fxq "scripts/backup-datastores.sh" "$test_dir/monitoring.files"
grep -Fxq "scripts/restore-backup-drill.sh" "$test_dir/monitoring.files"
grep -Fxq "scripts/install-backup-cron.sh" "$test_dir/monitoring.files"
grep -Fxq "scripts/test-alertmanager-notification.sh" "$test_dir/monitoring.files"
...
grep -Fxq "scripts/apply-ec2-env-remote.sh" "$test_dir/all.files"
grep -Fxq "scripts/deploy-monitoring.sh" "$test_dir/all.files"
grep -Fxq "scripts/configure-rtc-turn.sh" "$test_dir/all.files"

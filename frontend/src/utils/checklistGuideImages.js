...
const CHECKLIST_GUIDE_CONTENT = {
  ...
  'Windows 노트북': {
    ...
    'DSP-002': {
      image: dsp002Touch,
      title: '디스플레이·스피커 확인',
      summary: '화면 표시 상태와 좌우 스피커의 소리 출력을 영상으로 확인해 주세요.',
      purpose: '디스플레이 화면과 스피커 정상 작동 확인',
      guide: '흰색·검은색 화면을 차례로 전체 화면에 띄워 잔상, 줄무늬, 얼룩 및 불량 화소가 없는지 보여 주세요. 이어서 소리가 포함된 영상을 재생해 좌우 스피커에서 잡음이나 끊김 없이 소리가 나는지 확인할 수 있도록 한 영상으로 촬영해 주세요.',
    },
    'SYS-003': {
      image: lapScr013,

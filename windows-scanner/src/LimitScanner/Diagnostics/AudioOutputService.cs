...
public sealed class AudioOutputService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var buffer = CreateTone(sampleRate, durationMilliseconds, channel);
    ...
    private static byte[] CreateTone(int sampleRate, int durationMilliseconds, AudioChannel channel)
    {
